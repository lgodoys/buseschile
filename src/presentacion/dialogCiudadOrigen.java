/**
 * CONSTRUCTOR SWING PARA CREAR DIALOGO MANTENEDOR DE CIUDAD ORIGEN
 */
package presentacion;

import entidades.CiudadOrigen;
import negocio.CiudadOrigenNegocio;
...
public class dialogCiudadOrigen extends javax.swing.JDialog {
    ...
    private void guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarActionPerformed
        ...
        ciudadOrigen.setIDCiudad(idCiudad.getText());
        ciudadOrigen.setNombre(textoNombre.getText());
        ciudadOrigen.setRegion(boxRegion.getSelectedItem().toString());
        ciudadOrigen.setProvincia(boxProvincia.getSelectedItem().toString());
        try
        {
            int registrosAfectados = CiudadOrigenNegocio.getInstancia().crearCiudad(ciudadOrigen);
